...
module.exports = function(paths, outputDirectory, options, callback) {
  if (typeof outputDirectory === 'object' || typeof outputDirectory === 'function') {
  ...
  var buildPlaygrounds = files.map(function(file) {
    return function(callback) {
      var filePath = path.resolve(process.cwd(), file);
      var builder  = new PlaygroundBuilder(options);
      builder.createPlayground(filePath, outputDirectory, callback);
    }
  });

  async.parallel(buildPlaygrounds, callback);
};
